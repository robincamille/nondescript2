...
#setup
outfreq = open('train20split_data/train20split_10000_freqs.csv','w')
outcount = open('train20split_data/train20split_10000_counts_.csv','w')
totcount = open('train20split_data/train20split_10000_all-counts.csv','w')
outword = open('train20split_data/train20split_10000_wordlen.csv','w')
outsent = open('train20split_data/train20split_10000_sentlen.csv','w')

datadir = '/Users/robin/Documents/Thesis_local/corpora/blogs/train70_split/' #data directory
infile = open('train20split.txt','r')
...
inf = open('train20_data/train20split_10000_freqs.csv','r')
f = inf.readlines()
inf.close()

out = open('train20_data/train20split_10000_freqs_smoothed.csv','w')
...
print 'Averaging word frequencies across all documents'
outavg = open('train20_data/train20split_10000_all-freqs_smoothed_avg_2col.csv','w')
...
inf = open('train20_data/train20split_10000_freqs_smoothed.csv','r')
fq = inf.readlines()
